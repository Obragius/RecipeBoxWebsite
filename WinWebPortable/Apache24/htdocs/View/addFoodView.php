...
<!-- Navigation bar -->
    ...
    <nav>
        <ul>
            ...
            <?php endif ?>
            <li> <a class="topLink" id="cartBtn" href="cart.php">Cart: </a> <a class="topLink" id="cartNum"><?php if (isset($_SESSION["Cart"])): ?><?= sizeof($_SESSION["Cart"]) ?> <?php else: ?><?= 0 ?><?php endif ?></a> </li>
        </ul>
    </nav>
